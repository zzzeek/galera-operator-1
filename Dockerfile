...
ARG IMAGE_COMPONENT="galera-operator-container"
ARG IMAGE_NAME="galera-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Galera Operator"
ARG IMAGE_DESC="This image includes the galera-operator"
...
ENV USER_UID=$USER_ID \
    OPERATOR_TEMPLATES=/usr/share/galera-operator/templates/ \
